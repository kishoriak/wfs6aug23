...
public class ProductController {
	...
	public ModelAndView getByPrice(@PathVariable double lpr,@PathVariable double hpr) {
	...
	public ModelAndView editProduct(@PathVariable("pid") int p,@RequestParam int pid) {
		...
		Optional<Product> prod=pservice.getById(p);
		return new ModelAndView("editProduct","prod",prod.get());
